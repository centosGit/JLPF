 ...
 * {@link dk.itu.spcl.eyedroid.sdk.io.IOProtocolWriter}. Clients of this class should first set a proper
 * {@link dk.itu.spcl.eyedroid.sdk.io.IOProtocolWriter} instance and then use the
 * {@link dk.itu.spcl.eyedroid.sdk.io.OutputWriter#writeOutput(dk.itu.spcl.eyedroid.sdk.common.Bundle)} to write the next
 * processed {@link dk.itu.spcl.eyedroid.sdk.common.Bundle} to the output.
 */
